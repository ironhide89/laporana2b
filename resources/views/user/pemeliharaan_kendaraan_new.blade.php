...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="card card-premier">
                <div class="card-header">
                    <h3 class="card-title">Form Laporan Pemeliharaan {{ $vehicle->vehicle_name }}</h3>
                </div>
                <div class="card-body">
                    
                    <form action="{{ route('user.store_pemeliharaan_new') }}" method="POST" enctype="multipart/form-data" id="maintenanceForm" >
                        @csrf
                        <!-- Bagian 1 -->
                            ...
                            <div class="row mt-5">
                                <div class="col-sm-6" id="vehicle_name">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_dinas" value="{{ $todo->nama_dinas }}" readonly required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row d-none">
                                <div class="col-sm-6" id="vehicle_name">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="id" value="{{ $todo->id }}" readonly required>
                                    </div>
                                </div>
                            </div>
