        ...
        <div class="col-12 table-responsive">
            <table class="table table-borderless" style="width: 100%;">
                ...
                <tbody>
                    <tr>
                        <td class="border-left">1</td>
                        <td>Handrem Tangki Air</td>
                        <td>{{ $vehicle->handrem_tangki_air }}</td>
                        <td class="border-left">2</td>
                        <td>Friction Tyre Kanan</td>
                        <td>{{ $vehicle->friction_tyre_kanan }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">3</td>
                        <td>Friction Tyre Kiri</td>
                        <td>{{ $vehicle->friction_tyre_kiri }}</td>
                        <td class="border-left">4</td>
                        <td>Distance Tyre Tengah</td>
                        <td>{{ $vehicle->distance_tyre_tengah }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">5</td>
                        <td>Loadcell</td>
                        <td>{{ $vehicle->loadcell }}</td>
                        <td class="border-left">6</td>
                        <td>Connector Kabel</td>
                        <td>{{ $vehicle->connector_kabel }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">7</td>
                        <td>Fungsi Pompa Air</td>
                        <td>{{ $vehicle->fungsi_pompa_air }}</td>
                        <td class="border-left">8</td>
                        <td>Kondisi Tangki Air</td>
                        <td>{{ $vehicle->kondisi_tangki_air }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">9</td>
                        <td>Laptop</td>
                        <td>{{ $vehicle->laptop }}</td>
                        <td class="border-left">10</td>
                        <td>Kalibrasi Jarak</td>
                        <td>{{ $vehicle->kalibrasi_jarak }}</td>
                    </tr>
                </tbody>
