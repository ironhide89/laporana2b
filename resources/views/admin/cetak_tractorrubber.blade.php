        ...
        <div class="col-12 table-responsive">
            <table class="table table-borderless" style="width: 100%;">
                ...
                <tbody>
                    <tr>
                        <td class="border-left">1</td>
                        <td>Fungsi Gerakan Shourd</td>
                        <td>{{ $vehicle->fungsi_gerakan_shourd }}</td>
                        <td class="border-left">2</td>
                        <td>Fungsi Putaran Kumparan</td>
                        <td>{{ $vehicle->fungsi_putaran_kumparan }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">3</td>
                        <td>Nozzle</td>
                        <td>{{ $vehicle->nozzle }}</td>
                        <td class="border-left">4</td>
                        <td>Selang Hidrolis</td>
                        <td>{{ $vehicle->selang_hidrolis }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">5</td>
                        <td>Seal Brush Button</td>
                        <td>{{ $vehicle->seal_brush_button }}</td>
                        <td class="border-left">6</td>
                        <td>Seal Swivel Shaft</td>
                        <td>{{ $vehicle->seal_swifel_shaft }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">7</td>
                        <td>Seal Gasket</td>
                        <td>{{ $vehicle->seal_gasket }}</td>
                        <td class="border-left">8</td>
                        <td>Seal Upper</td>
                        <td>{{ $vehicle->seal_upper }}</td>
                    </tr>
                    <tr>
                        <td class="border-left">9</td>
                        <td>Dirt Shield</td>
                        <td>{{ $vehicle->drit_shield }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
